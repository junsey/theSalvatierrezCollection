    ...
    async function hydrate() {
      ...
      directors.forEach((director) => {
        ...
        if (cached) {
          ...
          if (cachedTotal != null) {
            cachedCoverage[director.key] = { owned: director.worksCount, total: cachedTotal };
          }
        }
      });
    ...
    async function loadCoverage() {
      ...
      profiles.forEach((profile) => {
        ...
        if (totalFromCache != null) {
          initialCoverage[profile.key] = { owned: profile.worksCount, total: totalFromCache };
        } else {
      ...
      profiles.forEach((profile) => {
        ...
        if (total != null) {
          nextCoverage[profile.key] = { owned: profile.worksCount, total };
        }
